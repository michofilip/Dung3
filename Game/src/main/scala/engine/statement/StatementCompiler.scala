...
object StatementCompiler {
    ...
    private def compileVariant(variantWhenTherefore: VariantWhenTherefore, chooseValue: Value[_], exitLabelId: Int,
                               labelId: Int): (Vector[Instruction], Int) = {
    ...
    private def compileChoose(value: Value[_], variants: Vector[VariantWhenTherefore], otherwise: Statement,
                              instructions: Vector[Instruction], labelId: Int): (Vector[Instruction], Int) = {
