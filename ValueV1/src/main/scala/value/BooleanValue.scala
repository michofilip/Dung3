...
object BooleanValue {
    ...
    final case class NOT(value: BooleanValue) extends BooleanValue {
        override def get: Option[Boolean] = value.get.map(v => !v)
    }
    
    final case class AND(value1: BooleanValue, value2: BooleanValue) extends BooleanValue {
        override def get: Option[Boolean] = value1.get.flatMap(v1 => value2.get.map(v2 => v1 && v2))
    }
    ...
    final case class XOR(value1: BooleanValue, value2: BooleanValue) extends BooleanValue {
        override def get: Option[Boolean] = value1.get.flatMap(v1 => value2.get.map(v2 => (v1 && !v2) || (!v1 && v2)))
    }
